            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {!imageSource && !Loading && res.placeholder}
                </Upload>
              </Form.Item>
            );
          }
                ...
                <div className={`grid gap-4 grid-cols-4 ${res?.className}`}>
                  {listMultipleImages?.map((res: any, i: number) => (
                    <img
                      ...
                      src={res?.url}
                      alt=""
                      className="w-full object-contain aspect-square border bg-neutral-100 rounded-lg"
                    />
                  ))}
                  <Upload
                    disabled={listMultipleImages.length >= (res?.max || 6)}
                    listType="picture-card"
                    className={`avatar-uploader !w-full aspect-square ${
                      listMultipleImages.length >= res?.max && " !hidden"
                    }`}
                    customRequest={() => {}}
                    showUploadList={false}
                    accept="image/png, image/jpg, image/jpeg"
                  ...
                  >
                    ...
                    {!loadingMultipleImage && (
                      <div className="w-full object-contain aspect-square  bg-neutral-100 rounded-lg flex flex-col gap-2 items-center justify-center">
                        {/* <RiImageAddFill className=" text-3xl" /> */}
                        <img src="/img/whiteboard.png" />
                        <p className="text-sm ">Upload here</p>
                      </div>
                    )}
                  </Upload>
                </div>
